package id.ac.polbeng.ahmedfadlu.gpsexample
...
import id.ac.polbeng.ahmedfadlu.gpsexample.databinding.ActivityMainBinding
...
// Got last known location. In some rare situations this can be null. logResultsToScreen("${location?.latitude}, ${location?.longitude}")
